...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /** @hide */
        private static final Validator STATUS_BAR_SHOW_CARRIER_VALIDATOR = NON_NEGATIVE_INTEGER_VALIDATOR;
    ...
    public static final class Secure extends NameValueTable {
         ...
         * 4: Display the battery as a big circle
         * 5: Display the battery as text
         * 6: Do not display the battery
         * 7: Display the battery as a big dotted circle
         * default: 0
         * @hide
         */
